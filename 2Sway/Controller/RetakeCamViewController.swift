...
class RetakeCamViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(restartCamera ), name: Notification.Name("restartCamera"), object: nil)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let vc = segue.destination as? ConfirmPicViewController {
            vc.newImage = profileImage
        }
    }
...
extension RetakeCamViewController: AVCapturePhotoCaptureDelegate {
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        ...
        performSegue(withIdentifier: K.Segues.isThisOkay, sender: self)
    }
}
